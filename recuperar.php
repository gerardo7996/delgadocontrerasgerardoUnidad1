...
<head>
	...
	<!-- API del Recaptcha V2 de Google -->
...
<body class="sb-nav-fixed">
	...
	<div class="container mt-5">
		...
		<form action="back-recuperación.php" method="POST">
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						<label for="email"><strong>Correo Electónico</strong></label>
			...
			<center>
				<button class="btn" type="submit" name="reset-pswd" id="reset-pswd"><i class="bi bi-repeat">   </i><strong>Recuperar Contraseña</strong></button><br>
			</center>
			<br>
		</form>
	</div>
...
<script type="text/javascript" src="js/validar-reset-pswd.js"></script>